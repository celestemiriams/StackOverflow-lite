...
class Links(object):
    ...
    def generate(app):
        ...
        app.add_url_rule('/api/v1/questions/',
                         view_func=QuestionsController.as_view('get_questions'),
                         methods=['GET'], strict_slashes=False)
        app.add_url_rule('/api/v1/questions/<int:question_id>/',
                         view_func=QuestionsController.as_view('get_a_question'),
                         methods=['GET'], strict_slashes=False)
        app.add_url_rule('/api/v1/questions/',
                         view_func=QuestionsController.as_view('post_a_question'),
